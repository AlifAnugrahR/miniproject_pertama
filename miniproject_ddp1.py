...
if pilihan == "1":
    ...
    print(f"barang '{nama}' berhasil ditambahkannn:D")
...
# UPDATE
    ...
    if len(inventaris) == 0:
        ...
        indeks = int(input("Masukkan nomor barang yang ingin diperbarui ")) - 1
...
# DELETE
    ...
    if len(inventaris) == 0:
        ...
        if 0 <= indeks < len(inventaris):
            ...
            print(f"barang '{barang[0]}' berhasil dihapus. TAPI BUKAN KENANGAN BERSAMANYA KANN?")
        else:
            print("Nomor tidak valid.")
